...
module.exports = {
    name: "show-soylist",
    description: "Posts all SOYLISTED members",
    aliases: ["show-sl","showsl"],
    command_usage: "```\nb!show-soylist\n```",
    run: async (client, message, args) => {
        ...
        try {
            //Storing contents of soylist.json in jsonString as a string
            ...
            //For each ID in the soylist, store the respective user's tag in goldiesList
            for (let i=0;i<jsonData.soylist.length;i++) {
                const userID = jsonData.soylist[i].id;
