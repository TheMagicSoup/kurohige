 ...
 */
declare class NextPageButton extends ButtonData {
    /**
     * Button that switches pagination to the next page.
     * @param {ButtonStyling} style Data from which to build NextPageButton.
     */
    constructor(style?: ButtonStyling);
    /**
     ...
     */
    private static _shouldBeDisabled;
}
